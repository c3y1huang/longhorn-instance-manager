...
type SpdkInstanceSpec struct {
	...
	SlotIndex uint32 `protobuf:"varint,11,opt,name=slot_index,json=slotIndex,proto3" json:"slot_index,omitempty"`
	...
	LvsName string `protobuf:"bytes,12,opt,name=lvs_name,json=lvsName,proto3" json:"lvs_name,omitempty"`
	...
	// the two identifiers.
	// Empty for non-shard instances.
	LvsUuid string `protobuf:"bytes,13,opt,name=lvs_uuid,json=lvsUuid,proto3" json:"lvs_uuid,omitempty"`
	...
	ShardGroupSpec *ShardGroupSpec `protobuf:"bytes,14,opt,name=shard_group_spec,json=shardGroupSpec,proto3" json:"shard_group_spec,omitempty"`
}
...
type InstanceCreateRequest struct {
	...
	// data_layout_type — set when InstanceSpec.type == "engine". The instance
	// manager forwards this to spdkrpc.EngineCreateRequest.data_layout_type so
	// the engine selects its upstream-RPC dispatch (Replica vs. ShardGroup).
	// Carried at the request level — NOT inside SpdkInstanceSpec — so that
	// SpdkInstanceSpec stays structurally identical for RAID1 and EC engines
	// and the InstanceDelete path remains layout-blind.
...
var file_imrpc_instance_proto_rawDesc = []byte{
	...
	0x61, 0x72, 0x67, 0x73, 0x22, 0x97, 0x05, 0x0a, 0x10, 0x53, 0x70, 0x64, 0x6b, 0x49, 0x6e, 0x73,
	...
	,
