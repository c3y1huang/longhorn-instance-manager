...
//	"k": Required. Number of data chunks per stripe.
//	"m": Required. Number of parity chunks per stripe.
//	"stripSizeKB": Required. Chunk size in KiB (e.g. 64).
//	"baseBdevs": Required. Ordered list of k+m base bdev names.
func (c *Client) BdevEcCreate(name string, dataChunks, parityChunks, stripSizeKB uint32, baseBdevs []string) (bdevName string, err error) {
